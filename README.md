...
function addChatSupportStyles() {
  ...
  style.textContent = `
    ...
    @media (max-width: 360px) {
      .chat-support-title { font-size: 0.85rem; }
      .back-button i { font-size: 1.1rem; }
    }

    @media (min-width: 361px) and (max-width: 480px) {
      .chat-support-title { font-size: 0.9rem; }
    }

    @media (min-width: 481px) and (max-width: 600px) {
      .chat-support-title { font-size: 1rem; }
      .back-button i { font-size: 1.3rem; }
    }

    @media (min-width: 601px) and (max-width: 768px) {
      .chat-support-header { padding: 1rem 1.25rem; }
      .chat-support-title { font-size: 1.1rem; }
      .back-button i { font-size: 1.4rem; }
    }

    @media (min-width: 769px) and (max-width: 1024px) {
      .chat-support-header { padding: 1.25rem 1.5rem; }
      .chat-support-title { font-size: 1.25rem; }
      .back-button i { font-size: 1.5rem; }
    }

    @media (min-width: 1025px) {
      .chat-support-header { padding: 1.5rem 2rem; }
      .chat-support-title { font-size: 1.4rem; }
      .back-button i { font-size: 1.7rem; }
    }

    @media (min-width: 1440px) {
      .chat-support-title { font-size: 1.5rem; }
    }
    ...
    .chat-support-content {
      ...
      margin: 0 auto;
      padding: 20px;
      padding-bottom: 100px; /* Space for search bar */
    }
